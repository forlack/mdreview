...
Run `mdreview .`, browse the Markdown files in the current project, select text
in the rendered document, and save durable review comments in a transparent
`.md-review/` directory beside the project files.
